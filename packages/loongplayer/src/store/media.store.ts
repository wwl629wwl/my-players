...
export default class MediaStore extends BaseStore<MediaState> {
    ...
    @bind
    onCanPlay() {
        this.player.emit(LOONG_PLAYER_EVENT.VIDEO_CAN_PLAY);
    }
    ...
    onDurationChange() {
        ...
        this.player.emit(
            LOONG_PLAYER_EVENT.VIDEO_DURATION_CHANGED,
    ...
    onTimeUpdate() {
        ...
        this.player.emit(
            LOONG_PLAYER_EVENT.VIDEO_TIME_UPDATE,
    ...
    onPlay() {
        ...
        this.player.emit(LOONG_PLAYER_EVENT.VIDEO_PLAY);
    }

    @bind
    onPause() {
        this.setState('paused', this.videoElement.paused);
        this.player.emit(LOONG_PLAYER_EVENT.VIDEO_PAUSE);
    }

    @bind
    onSeeked() {
        this.player.emit(LOONG_PLAYER_EVENT.VIDEO_SEEKED, this.videoElement.currentTime);
    }
    ...
    onVolumeChange() {
        ...
        this.player.emit(
            LOONG_PLAYER_EVENT.VIDEO_VOLUME_CHANGED,
    ...
    onRateChange() {
        ...
        this.player.emit(
            LOONG_PLAYER_EVENT.VIDEO_PLAYRATE_CHANGED,
    ...
    onWaiting() {
        ...
        this.player.emit(LOONG_PLAYER_EVENT.VIDEO_WAITING);
    }

    @bind
    onPlaying() {
        this.setState('waiting', false);
        this.player.emit(LOONG_PLAYER_EVENT.VIDEO_PLAYING);
    }
