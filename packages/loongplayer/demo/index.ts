import { LoongPlayer, WebCodecProxy, CanvasProxy } from '../src/index'

const player = new LoongPlayer({
...
player.on(LoongPlayer.Event.VIDEO_QUALITY_CHANGING, (q) => {
    console.log('开始切换清晰度', q)
})

player.on(LoongPlayer.Event.VIDEO_QUALITY_CHANGED, (q) => {
